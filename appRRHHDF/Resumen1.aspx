<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Resumen1.aspx.cs" Inherits="appRRHHDF.Resumen1" %>
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<ul class="nav nav-tabs">
						<li class="nav-items"><asp:LinkButton ID="lbtnDatosPersonales" CausesValidation="false" class="nav-link" OnClick="lbtnDatosPersonales_Click" runat="server">Datos personales</asp:LinkButton></li>
						<li class="nav-items"><asp:LinkButton ID="lbtnDatosFam" CausesValidation="false" class="nav-link" OnClick="lbtnDatosFam_Click" runat="server">Datos familiares</asp:LinkButton></li>
						<li class="nav-items"><asp:LinkButton ID="lbtnEstudiosRealizados" CausesValidation="false" class="nav-link" OnClick="lbtnEstudiosRealizados_Click" runat="server">Estudios Realizados</asp:LinkButton></li>
                        <li class="nav-items"><asp:LinkButton ID="lbtnCursosTalleres" CausesValidation="false" class="nav-link" OnClick="lbtnCursosTalleres_Click" runat="server">Cursos/Talleres</asp:LinkButton></li>
						<li class="nav-items"><asp:LinkButton ID="lbtnNivelIdioma" CausesValidation="false" class="nav-link" OnClick="lbtnNivelIdioma_Click" runat="server">Idiomas</asp:LinkButton></li>
						<li class="nav-items"><asp:LinkButton ID="lbtnExpLaboral" CausesValidation="false" class="nav-link" OnClick="lbtnExpLaboral_Click" runat="server">Experiencia Laboral</asp:LinkButton></li>
                        <li class="nav-items"><asp:LinkButton ID="lbtnRefLaboral" CausesValidation="false" class="nav-link" OnClick="lbtnRefLaboral_Click" runat="server">Referencia Laboral</asp:LinkButton></li>
						<li class="nav-items"><asp:LinkButton ID="lbtnOtrosDatos" CausesValidation="false" class="nav-link" OnClick="lbtnOtrosDatos_Click" runat="server">Otros Datos</asp:LinkButton></li>
						<li class="nav-items"><asp:LinkButton ID="lbtnResumen" CausesValidation="false" class="nav-link active" OnClick="lbtnResumen_Click" runat="server">Resumen</asp:LinkButton></li>
					</ul>
                                    ...
                                    <div class="bloque_perfil col-lg-11">
                                            ...
                                            <ItemTemplate>
                                                 <div class="perfil_personal col-lg-3">                                           
                                                   ...
                                                   <div class="perfil_cargo col-lg-9"> 
                                                           <p>Titulo en: <asp:Label ID="lblEstudios3" runat="server" Text='<%# Eval("PES_TITULO_OBTENIDO") %>'></asp:Label></p>
                                                           <p>Universidad o Insttucion: <asp:Label ID="lblEstudios4" runat="server" Text='<%# Eval("PES_INSTITUCION") %>'></asp:Label></p>
                                                   </div>
                                            </ItemTemplate>
                                        </asp:Repeater>                                      
					               </div>
                                     <div class="bloque_perfil col-lg-11">
                                         ...
                                         <asp:Repeater ID="Repeater2" DataSourceID="odsExperienciaLaboral" runat="server">
                                             <ItemTemplate>
                                                 ...
                                                 <div class="col-12">
                                                   <div class="perfil_personal col-lg-4">                                           
                                                       <p><b>De <asp:Label ID="lblExperiencia1" runat="server" Text='<%# Eval("PEX_FECHA_INICIO_CARGO") %>'></asp:Label> a <asp:Label ID="lblExperiencia3" runat="server" Text='<%# Eval("PEX_FECHA_FIN_CARGO") %>'></asp:Label></b></p>                                           
                                                       <p><b>Años experiencia: <asp:Label ID="lblExperiencia2" runat="server" Text='<%# Eval("PEX_TOTAL_EXPERIENCIA") %>'></asp:Label></b></p>
                                                   </div>
                                                   <div class="perfil_cargo col-lg-8"> 
                                                       ...
                                                       <br />                                                       
                                                           <div class="col-12" style="display:inline-block" >
                                                            <h4 style="text-decoration: underline #000;"> Cargo Ocupado: <asp:Label ID="lblCargoOcupado1" runat="server" Text='<%# Eval("PEX_CARGO") %>'></asp:Label></h4>
                                                               <div class="row"></div>
                                                               <div class="4" style="float:left;display:block;margin:0px;">
                                                                   <h4>Tareas realizadas: </h4>
                                                               </div>
                                                               <div class="8" style="float:left;display:block;margin:0px;">
                                                                   <ul>
                                                                     ...
                                                                     <%--  <li> XxxxxxxxxxxxxxxXxxxxxXxxxxxxxxxxxxxxXxxxxxxxxxxxxxxxxxXxxxxxXxxxxxxxxxxxxxx</li>
                                                                       <li> XxxxxxxxxxxxxxxxXxxxxxxxxxxxxxxxxxxxxxxxxxxXxxxxxxxxxxxxxxxxxxxxxx</li>--%>
                                                                   </ul>
                                                               </div>

                                                           </div> 

                                                       <asp:Panel ID="planel_cargo1" Visible='<%# Eval("PEX_CARGO1_VISIBLE") %>' runat="server">
                                                           <div class="col-12"  style="display:inline-block">
                                                            <h4 style="text-decoration: underline #000;">2do Cargo Ocupado: <asp:Label ID="Label2" runat="server" Text='<%# Eval("PEX_OTRO_CARGO1") %>'></asp:Label></h4>
                                                               <div class="row"></div>
                                                               <div class="4" style="float:left;display:block;margin:0px;">
                                                                   <h4>Tareas realizadas: </h4>
                                                               </div>
                                                        ...
                                                        <asp:Panel ID="planel_cargo2" Visible='<%# Eval("PEX_CARGO2_VISIBLE") %>' runat="server">
                                                           <div class="col-12"  style="display:inline-block">
                                                            <h4 style="text-decoration: underline #000;">3er Cargo Ocupado: <asp:Label ID="Label4" runat="server" Text='<%# Eval("PEX_OTRO_CARGO2") %>'></asp:Label></h4>
                                                               <div class="row"></div>
                                                               <div class="4" style="float:left;display:block;margin:0px;">
                                                                   <h4>Tareas realizadas: </h4>
                                                               </div>
                                                       ...
                                                       <asp:Panel ID="planel_cargo3" Visible='<%# Eval("PEX_CARGO3_VISIBLE") %>' runat="server">
                                                           <div class="col-12"  style="display:inline-block">
                                                            <h4 style="text-decoration: underline #000;">4to Cargo Ocupado: <asp:Label ID="Label6" runat="server" Text='<%# Eval("PEX_OTRO_CARGO3") %>'></asp:Label></h4>
                                                               <div class="row"></div>
                                                               <div class="4" style="float:left;display:block;margin:0px;">
                                                                   <h4>Tareas realizadas: </h4>
                                                               </div>
                                        ...
                                        <%-- <div class="col-12">
                                                   <div class="perfil_personal col-lg-4">                                           
                                                       <p><b>De <asp:Label ID="Label6" runat="server" Text="00/00/0000"></asp:Label> a <asp:Label ID="Label7" runat="server" Text="00/00/0000"></asp:Label></b></p>                                           
                                                       <p><b> <asp:Label ID="Label8" runat="server" Text="(Ciudad - Pais)"></asp:Label></b></p>
                                                   </div>
                                                   <div class="perfil_cargo col-lg-8"> 
                                                            <h3><b><asp:Label ID="Label9" runat="server" Text="NOMBRE DE LA EMPRESA"></asp:Label>, </b>
                                                            <span> Sector: <asp:Label ID="Label10" runat="server" Text="Xxxxxxxxx"></asp:Label></span>
                                                                </h3>
                                                       <br />
                                                            <h4 style="font-style:unset; "> Cargo Ocupado: <asp:Label ID="Label11" runat="server" Text="Xxxxxxxxxxxxxxxxx Xxxxxxxxxxxxxxxxxxxxxxxxxxx"></asp:Label></h4>
                                                           <div class="col-12">
                                                               <div class="4" style="float:left;display:block;margin:0px;">
                                                                   <h4>Tareas realizadas: </h4>
                                                               </div>
                                                               <div class="8" style="float:left;display:block;margin:0px;">
                                                                   <ul>
                                                                       <li> XxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxXxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</li>
                                                                       <li> XxxxxxxxxxxxxxxXxxxxxXxxxxxxxxxxxxxxXxxxxxxxxxxxxxxxxxXxxxxxXxxxxxxxxxxxxxx</li>
                                                                       <li> XxxxxxxxxxxxxxxxXxxxxxxxxxxxxxxxxxxxxxxxxxxXxxxxxxxxxxxxxxxxxxxxxx</li>
                                                                   </ul>
                                                               </div>
                                         ...
                                         <div class="col-12">
                                                   <div class="perfil_personal col-lg-4">                                           
                                                       <p><b>De <asp:Label ID="Label12" runat="server" Text="00/00/0000"></asp:Label> a <asp:Label ID="Label13" runat="server" Text="00/00/0000"></asp:Label></b></p>                                           
                                                       <p><b> <asp:Label ID="Label14" runat="server" Text="(Ciudad - Pais)"></asp:Label></b></p>
                                                   </div>
                                                   <div class="perfil_cargo col-lg-8"> 
                                                            <h3><b><asp:Label ID="Label15" runat="server" Text="NOMBRE DE LA EMPRESA"></asp:Label>, </b>
                                                            <span> Sector: <asp:Label ID="Label17" runat="server" Text="Xxxxxxxxx"></asp:Label></span>
                                                                </h3>
                                                       <br />
                                                            <h4 style="font-style:unset; "> Cargo Ocupado: <asp:Label ID="Label18" runat="server" Text="Xxxxxxxxxxxxxxxxx Xxxxxxxxxxxxxxxxxxxxxxxxxxx"></asp:Label></h4>
                                                           <div class="col-12">
                                                               <div class="4" style="float:left;display:block;margin:0px;">
                                                                   <h4>Tareas realizadas: </h4>
                                                               </div>
                                     ...
                                     <div class="bloque_perfil col-lg-11">
                                        ...
                                        <asp:Repeater ID="Repeater3"  DataSourceID="odsCursosTalleres" runat="server">
                                            <ItemTemplate>
                                                 <div class="perfil_personal col-lg-3">                                           
                                                       <p><b>Fecha Emision: <asp:Label ID="lblCursos1" runat="server" Text='<%# Eval("PCR_FECHA_TITULO") %>'></asp:Label></b></p>                                           
                                                       <p><b>Tipo: <asp:Label ID="lblCursos2" runat="server" Text='<%# Eval("DESC_TIPO_CAPACITACION") %>'></asp:Label></b></p>
                                                   </div>
                                                   <div class="perfil_cargo col-lg-9"> 
                                                           <p>Instituciòn: <asp:Label ID="Cursos3" runat="server" Text='<%# Eval("PCR_INSTITUCION") %>'></asp:Label></p>
                                                           <p>Titulo Obtenido: <asp:Label ID="lblCursos" runat="server" Text='<%# Eval("PCR_TITULO_OBTENIDO") %>'></asp:Label></p>
                                                   </div>
                                            </ItemTemplate>
                                        </asp:Repeater>                                      
					               </div>                                    
                                        ...
                                        <asp:Repeater ID="Repeater4"  DataSourceID="odsIdiomas" runat="server">
                                            <ItemTemplate>
                                                 <div class="perfil_personal col-lg-4">                                                                               
                                                   ...
                                                   <div class="perfil_cargo col-lg-4"> 
                                                           <p><b>Nivel de Escrituran: </b><asp:Label ID="lblIdioma3" runat="server" Text='<%# Eval("DESC_ESCRITURA") %>'></asp:Label></p>
                                                           <p><b>Nivel de Lextura: </b><asp:Label ID="lblIdioma4" runat="server" Text='<%# Eval("DESC_LECTURA") %>'></asp:Label></p>
                                                   </div>
                                                    <div class="perfil_cargo col-lg-4"> 
                                                           <p><b>Nivel de Conversacion: </b><asp:Label ID="lblIdioma5" runat="server" Text='<%# Eval("DESC_CONVERSACION") %>'></asp:Label></p>
                                                           <p><b>Certificado: </b><asp:Label ID="lblIdioma6" runat="server" Text='<%# Eval("PID_CON_TITULO") %>'></asp:Label></p>
                                                   </div>
