...
namespace appRRHHDF.clases
{
    public class Ciudades
    {
        ...
        public Int64 PI_ID_CIUDAD { get { return _PI_ID_CIUDAD; } set { _PI_ID_CIUDAD = value; } }
        ...
        //    RecuperarDatos();
        //}
        public Ciudades(string pV_TIPO_OPERACION, Int64 pI_ID_CIUDAD,
         Int64 pI_ID_PAIS, string pV_CIUDAD, string pV_USUARIO)
        {
            _PV_TIPO_OPERACION = pV_TIPO_OPERACION;
            _PI_ID_CIUDAD = pI_ID_CIUDAD;
        ...
        public static DataTable Lista(string PI_ID_PAIS)
        {
            try
            {
                DbCommand cmd = db1.GetStoredProcCommand("PR_PAR_GET_CIUDAD");
                db1.AddInParameter(cmd, "PI_ID_PAIS", DbType.String, PI_ID_PAIS);
        ...
        public string ABM()
        {
            ...
            {
                // verificar_vacios();
                DbCommand cmd = db1.GetStoredProcCommand("PR_PAR_ABM_CIUDAD");
                db1.AddInParameter(cmd, "PV_TIPO_OPERACION", DbType.String, _PV_TIPO_OPERACION);
                db1.AddInParameter(cmd, "PI_ID_CIUDAD", DbType.Int64, _PI_ID_CIUDAD);
