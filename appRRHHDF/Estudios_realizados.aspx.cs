    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (lblIdEstudios.Text == "")
                    {
                        clases.Estudios_realizados obj_er = new clases.Estudios_realizados("I", 0, Int64.Parse(lblIdPersonal.Text), dllNivelEstudio.SelectedValue,
                            txtNombreInstitucion.Text, txtAreaEstudio.Text,
                           txtCiudad.Text, fecha_ini, fecha_fin, concluido, txtTituloOb.Text, fecha_titulo,
                           lblUsuario.Text);
                        lblAviso.Text = obj_er.ABM();
                    }
                    else
                    {
                        clases.Estudios_realizados obj_er = new clases.Estudios_realizados("U", Int64.Parse(lblIdEstudios.Text), Int64.Parse(lblIdPersonal.Text),
                            dllNivelEstudio.SelectedValue, txtNombreInstitucion.Text, txtAreaEstudio.Text,
                            txtCiudad.Text, fecha_ini, fecha_fin, concluido, txtTituloOb.Text, fecha_titulo,
                            lblUsuario.Text);
                        lblAviso.Text = obj_er.ABM();
                    }
            ...
            {
                string nombre_archivo = "error_estudios_" + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + ".txt";
        ...
        protected void dllNivelEstudio_DataBound(object sender, EventArgs e)
        {
            dllNivelEstudio.Items.Insert(0, "SELECCIONAR UNA OPCION");
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            clases.Estudios_realizados obj_est = new clases.Estudios_realizados(Int64.Parse(id));
            lblIdEstudios.Text = obj_est.PB_ID_ESTUDIO.ToString();
            txtCiudad.Text = obj_est.PV_CIUDAD.ToString();
            txtNombreInstitucion.Text = obj_est.PV_INSTITUCION.ToString();
            txtTituloOb.Text = obj_est.PV_TITULO_OBTENIDO.ToString();
            string aux_c = obj_est.PV_CONCLUIDO.ToString();
            //if (aux_c == "SI")
            //    ckbConcluido.Checked = true;
            //else
            //    ckbConcluido.Checked = false;
            cargar_calendarios();
            ...
            dllNivelEstudio.SelectedValue = obj_est.PV_NIVEL_ESTUDIO.ToString();
            txtAreaEstudio.Text= obj_est.PV_AREA_ESTUDIO.ToString();
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            clases.Estudios_realizados obj_er = new clases.Estudios_realizados("D", Int64.Parse(lblIdEstudios.Text), Int64.Parse(lblIdPersonal.Text),
                dllNivelEstudio.SelectedValue, txtNombreInstitucion.Text, txtAreaEstudio.Text,
                  txtCiudad.Text, fecha_ini, fecha_fin,concluido ,txtTituloOb.Text,fecha_titulo,
                  lblUsuario.Text);
            lblAviso.Text = obj_er.ABM();
