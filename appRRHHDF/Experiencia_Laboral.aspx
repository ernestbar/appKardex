			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<ul class="nav nav-tabs" style="background-color:#6d6d6f;">
						...
						<li class="nav-items"><asp:LinkButton ID="lbtnExpLaboral" ForeColor="White" CausesValidation="false" class="nav-link active" OnClick="lbtnExpLaboral_Click" runat="server">Experiencia Laboral</asp:LinkButton>	</li>
							                         ...
							                         <div class="conten_form" style="border:1px solid #d8dfeb; position:relative; padding:10px;float:left;">       
                                                             <div class="conten_form">                        
                                                                <div class="form-group m-b-20 col-lg-8" style="float:left">
                                                                    <span>Empresa</span>
                                                                    <asp:TextBox ID="txtEmpresaV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_EMPRESA") %>'></asp:TextBox>
                                                                </div>                                   
                                                               <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Cargo de inicio</span>
                                                                    <asp:TextBox ID="txtCargoInicioV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_CARGO") %>'></asp:TextBox>
                                                                </div>
                                                              <%--  <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Nro. Dependientes</span>
                                                                    <asp:TextBox ID="txtNroDependientesV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_NRO_DEPENDIENTES_CARGO") %>'></asp:TextBox>
                                                                </div>--%>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Experiencia en Años </span>
                                                                    <asp:TextBox ID="TextBox1" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_TOTAL_EXPERIENCIA") %>'></asp:TextBox>
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Funciones</span>
                                                                    <asp:TextBox ID="txtFuncionesV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FUNCIONES_CARGO") %>'></asp:TextBox>
                                                                </div>
									                            <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Inicio</span>
                                                                    <asp:TextBox ID="txtFechaIniV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_INICIO_CARGO") %>'></asp:TextBox>
                                                                    <%-- <asp:TextBox ID="txtFechaIniV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_INICIO_CARGO") %>'></asp:TextBox>     --%>                               
                                                                </div>
                                                                <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Final</span>
                                                                    <asp:TextBox ID="txtFechaFinV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_FIN_CARGO") %>'></asp:TextBox>
                                                                    <%-- <asp:TextBox ID="txtFechaFinV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_FIN_CARGO") %>'></asp:TextBox>    --%>                               
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Departamento</span>
                                                                    <asp:TextBox ID="txtDepartamentoV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_DEPARTAMENTO_CARGO") %>'></asp:TextBox>
                                                                </div>
                                                                  <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <br />  
                                                                ...
                                                                <div class="form-group m-b-20 col-lg-12" style="float:left">
						                                            ...
						                                            <asp:TextBox ID="txtDesvinculacionV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("DES_MOTIVO_DESVINCULACION")%>'></asp:TextBox>
                                                                </div>   
                                                                 <asp:Panel ID="Panel1" Visible='<%# Eval("PEX_CARGO1_VISIBLE") %>' runat="server">
                                                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Otro cargo 1</span>
                                                                    <asp:TextBox ID="txtOtroCargo1V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_OTRO_CARGO1") %>'></asp:TextBox>
                                                                </div>                                                                
                                                               <%-- <div class="form-group m-b-20 col-lg-2" style="float:left">
                                                                    <span>Nro. Dependientes</span>
                                                                    <asp:TextBox ID="txtNroDependientesOtro1V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_NRO_DEPENDIENTES_OTRO1") %>'></asp:TextBox>
                                                                </div>--%>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Experiencia Años</span>
                                                                    <asp:TextBox ID="TextBox2" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_TOTAL_EXPERIENCIA_OTRO1") %>'></asp:TextBox>
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Funciones Otro Cargo 1</span>
                                                                    <asp:TextBox ID="txtFuncionesOtro1V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FUNCIONES_OTRO1") %>'></asp:TextBox>
                                                                </div>
                                                                <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Inicio</span>
                                                                     <asp:TextBox ID="txtFechaIniOtro1V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_INICIO_OTRO1") %>'></asp:TextBox>                                    
                                                                </div>
                                                                <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Final</span>
                                                                     <asp:TextBox ID="txtFechaFinOtro1V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_FIN_OTRO1") %>'></asp:TextBox>                                   
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Departamento Otro Cargo 1</span>
                                                                    <asp:TextBox ID="txtDepartamentoOtro1V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_DEPARTAMENTO_OTRO1") %>'></asp:TextBox>
                                                                </div>
                                                                 </asp:Panel>
                                                                   ...
                                                                   <asp:TextBox ID="txtOtroCargo2V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server"  Text='<%# Eval("PEX_OTRO_CARGO2") %>'></asp:TextBox>
                                                                </div>                                                                
                                                             <%--   <div class="form-group m-b-20 col-lg-2" style="float:left">
                                                                    <span>Nro. Dependientes</span>
                                                                    <asp:TextBox ID="txtNroDependientesOtro2V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_NRO_DEPENDIENTES_OTRO2") %>'></asp:TextBox>
                                                                </div>--%>
                                                                   <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Experiencia Años</span>
                                                                    <asp:TextBox ID="TextBox3" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_TOTAL_EXPERIENCIA_OTRO2") %>'></asp:TextBox>
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Funciones Otro Cargo 1</span>
                                                                    <asp:TextBox ID="txtFuncionesOtro2V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FUNCIONES_OTRO2") %>'></asp:TextBox>
                                                                </div>
                                                                <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Inicio</span>
                                                                     <asp:TextBox ID="txtFechaIniOtro2V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_INICIO_OTRO2") %>'></asp:TextBox>                                    
                                                                </div>
                                                                <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Final</span>
                                                                     <asp:TextBox ID="txtFechaFinOtro2V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_FIN_OTRO2") %>'></asp:TextBox>                                   
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Departamento  Otro Cargo 2</span>
                                                                    <asp:TextBox ID="txtDepartamentoOtro2V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_DEPARTAMENTO_OTRO2") %>'></asp:TextBox>
                                                                </div>
                                                                 </asp:Panel>
                                                                    ...
                                                                    <asp:TextBox ID="txtOtroCargo3V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_OTRO_CARGO3") %>'></asp:TextBox>
                                                                </div>                                                                
                                                                <%--<div class="form-group m-b-20 col-lg-2" style="float:left">
                                                                    <span>Nro. Dependientes</span>
                                                                    <asp:TextBox ID="txtNroDependientesOtro3V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_NRO_DEPENDIENTES_OTRO3") %>'></asp:TextBox>
                                                                </div>--%>
                                                                   <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Experiencia Años</span>
                                                                    <asp:TextBox ID="TextBox4" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_TOTAL_EXPERIENCIA_OTRO3") %>'></asp:TextBox>
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Funciones Otro Cargo 3</span>
                                                                    <asp:TextBox ID="txtFuncionesOtro3V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FUNCIONES_OTRO3") %>'></asp:TextBox>
                                                                </div>
                                                                <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Inicio</span>
                                                                     <asp:TextBox ID="txtFechaIniOtro3V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_INICIO_OTRO3") %>'></asp:TextBox>                                    
                                                                </div>
                                                                <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                                                    <span>Fecha Final</span>
                                                                     <asp:TextBox ID="txtFechaFinOtro3V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_FECHA_FIN_OTRO3") %>'></asp:TextBox>                                   
                                                                </div>
                                                                 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Departamento  Otro Cargo 3</span>
                                                                    <asp:TextBox ID="txtDepartamentoOtro3V" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_DEPARTAMENTO_OTRO3") %>'></asp:TextBox>
                                                                </div>
                                                                 </asp:Panel>
                                                              ...
                                                              <%--    <div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    ...
                                                                    <asp:TextBox ID="txtDesvinculacionOtro" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" Text='<%# Eval("PEX_DESVINCULACION_OTRO") %>'></asp:TextBox>
                                                                </div>--%>
					                                            
                                                                <%--<div class="form-group m-b-20 col-lg-4" style="float:left">
                                                                    <span>Total Experiencia Dias</span>
						                                           <asp:TextBox ID="txtTotalExperienciaV" ForeColor="Black" BackColor="#dae0ec" class="form-control form-control-lg inverse-mode" runat="server" ReadOnly="true" Text='<%# Eval("PEX_TOTAL_EXPERIENCIA") %>'></asp:TextBox>
									                             </div>--%>                                         
                                                        </div>	
                       ...
                       <asp:View ID="View2" runat="server">
                            ...
                            <div class="conten_form">       
                                   ...
                                   <div class="form-group m-b-20 col-lg-4" style="float:left">
						                ...
						                <asp:TextBox ID="txtCargoInicio" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="NOMBRE CARGO"></asp:TextBox>
                                    </div>
                                    <div class="form-group m-b-20 col-lg-3" style="float:left">
						                ...
						                <asp:TextBox ID="txtNroDependientes" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPENDIENTES"></asp:TextBox>
                                     ...
                                     <div class="form-group m-b-20 col-lg-9" style="float:left">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtFunciones"  Font-Bold="True"></asp:RequiredFieldValidator>
						                 <asp:TextBox ID="txtFunciones" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DESCRIPCION EN DETALLE DEL PUESTO DE TRABAJO"></asp:TextBox>
                                    </div>
                                     <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                        <span>Fecha Inicio *</span>
                                    ...
                                    <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                        ...
                                        <asp:Label ID="lblFecha2" runat="server" Text="" ForeColor="Red" Font-Size="Smaller"></asp:Label>
                                         <div class="row row-space-6">
													<div class="col-4">
                                                        <asp:DropDownList ID="ddlFinDia" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													...
													<div class="col-4">
														<asp:DropDownList ID="ddlFinMes" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													...
													<div class="col-4">
														<asp:DropDownList ID="ddlFinAño" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
                                     ...
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtDepartamento" Font-Bold="True"></asp:RequiredFieldValidator>
						                 <asp:TextBox ID="txtDepartamento" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPARTAMENTO"></asp:TextBox>
                                        <br />                                      </div>
                                    <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Otro cargo 1</span>
                                        <asp:TextBox ID="txtOtroCargo1" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder=""></asp:TextBox>
                                    </div>
									 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Nros. Dependientes Otro Cargo 1</span>
						                <asp:TextBox ID="txtNroDependientesOtro1" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPENDIENTES"></asp:TextBox>
                                    </div>
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Funciones Otro Cargo 1</span>
                                         
						                 <asp:TextBox ID="txtFuncionesOtro1" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DESCRIPCION OTRO CARGO"></asp:TextBox>
                                    </div>
                                     <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                        <span>Fecha Inicio</span>
                                         ...
                                         <div class="row row-space-6">
													<div class="col-4">
                                                        <asp:DropDownList ID="ddlIniDia1" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlIniMes1" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlIniAño1" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
												</div>
                                    ...
                                    <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                     ...
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Departamento Otro Cargo 1</span>
						                 <asp:TextBox ID="txtDepartamentoOtro1" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPARTAMENTO"></asp:TextBox>
                                             <br /> 
                                     </div>
																	
					                <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Otro cargo 2</span>
                                       <asp:TextBox ID="txtOtroCargo2" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder=""></asp:TextBox>
                                    </div>
									 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Nros. Dependientes Otro Cargo 2</span>
						                <asp:TextBox ID="txtNroDependientesOtro2" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPENDIENTES"></asp:TextBox>
                                    </div>
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Funciones Otro Cargo 2</span>
						                 <asp:TextBox ID="txtFuncionesOtro2" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DESCRIPCION OTRO CARGO"></asp:TextBox>
                                    </div>
                                     <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                        <span>Fecha Inicio</span>
                                         ...
                                         <div class="row row-space-6">
													<div class="col-4">
                                                        <asp:DropDownList ID="ddlIniDia2" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlIniMes2" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlIniAño2" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
												</div>
                                    ...
                                    <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                        ...
                                        <asp:Label ID="lblFecha6" runat="server" Text="" ForeColor="Red" Font-Size="Smaller"></asp:Label>
                                         <div class="row row-space-6">
													<div class="col-4">
                                                        <asp:DropDownList ID="ddlFinDia2" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlFinMes2" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlFinAño2" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
												</div>
                                     ...
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Departamento Otro Cargo 2</span>
						                 <asp:TextBox ID="txtDepartamentoOtro2" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPARTAMENTO"></asp:TextBox>
                                            <br /> 
                                     </div>
									
					                <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Otro cargo 3</span>
                                        <asp:TextBox ID="txtOtroCargo3" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder=""></asp:TextBox>
                                    </div>
									 <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Nros. Dependientes Otro Cargo 3</span>
						                <asp:TextBox ID="txtNroDependientesOtro3" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPENDIENTES"></asp:TextBox>
                                    </div>
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Funciones Otro Cargo 3</span>
						                 <asp:TextBox ID="txtFuncionesOtro3" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DESCRIPCION OTRO CARGO"></asp:TextBox>
                                    </div>
                                     <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                        <span>Fecha Inicio</span>
                                         ...
                                         <div class="row row-space-6">
													<div class="col-4">
                                                        <asp:DropDownList ID="ddlIniDia3" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlIniMes3" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlIniAño3" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
												</div>
                                    ...
                                    <div class="form-group m-b-20  col-lg-4" style="float:left">     
                                        ...
                                        <asp:Label ID="lblFecha8" runat="server" Text="" ForeColor="Red" Font-Size="Smaller"></asp:Label>
                                         <div class="row row-space-6">
													<div class="col-4">
                                                        <asp:DropDownList ID="ddlFinDia3" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlFinMes3" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
													<div class="col-4">
														<asp:DropDownList ID="ddlFinAño3" class="form-control form-control-lg inverse-mode" ForeColor="Black" runat="server"></asp:DropDownList>
													</div>
												</div>
                                     ...
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Departamento Otro Cargo 3</span>
						                 <asp:TextBox ID="txtDepartamentoOtro3" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server"  placeholder="DEPARTAMENTO"></asp:TextBox>
                                    </div>             
                                    <div class="form-group m-b-20 col-lg-4" style="float:left">
                                     ...
                                     <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Desvinculación Otro</span>
						                 <asp:TextBox ID="txtDesvinculacionOtro" ForeColor="Black" class="form-control form-control-lg inverse-mode" Enabled="false" runat="server"  placeholder="OTRO MOTIVO DE DESVINCULACION"></asp:TextBox>
                                    </div> 
					                <div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <br />  
                                    ...
                                    <%--<div class="form-group m-b-20 col-lg-4" style="float:left">
                                        <span>Total Experiencia Dias</span>
						               <asp:TextBox ID="txtTotalExperiencia" ForeColor="Black" class="form-control form-control-lg inverse-mode" runat="server" ReadOnly="true"  placeholder="TOTAL EXPERIENCIA"></asp:TextBox>
